...
def generate_hold_out_split (dataset, training = 0.8, base_dir=os.path.dirname(__file__)):
    r = random.Random()
    r.seed(1489215)
...
def kfold_split(dataset, training = 0.8, n_folds = 10, base_dir=os.path.dirname(__file__)):
